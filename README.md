...
5) Вас спросят надо ли обновить zapret-latest папку и nfwqs файл если их нету в папке(они не идут с гитом) то нажмите Y
6) Затем вас спросят режим ipset у меня лично лучше всего работает ANY выберите 1 или 2 или 3
7) Следующая настройка Gamemode в случае использования запрета для игр Y если нет то N
8) Выбор стратегии я выбираю 1 (general.bat)
9) Выбор интерфейса (устройства по которому у вас подключен интернет) чтообы узнать нужный используйте ls /sys/class/net
10) Затем запустится обфускация проверьте twitch/youtube/discord если работает прекрасно запомните настройки ( или посмотрите в conf.enf)
11) ctrl+c чтобы отключить обфускацию
